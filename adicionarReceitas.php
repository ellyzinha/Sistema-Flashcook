  ...
  <nav class="navbar-expand-md navbar-dark bg-dark navbar fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3SupportedContent">
        ...
        <a class="btn navbar-btn btn-secondary mx-2" href="perfilUser.php"><b>Bem Vindo, <?php echo $_SESSION['user']; ?>!</b></a>
      </div>
    </div>
  </nav>
    ...
    <div class="col-md-4">
		<div class="form_main">
                ...
                <form onsubmit="Checkfiles(this);">
                    ...
                    <input type="file" required="" value="" name="arquivos" id="filename" class="btn btn-sucess" accept="image/png, image/jpeg" multiple="">
