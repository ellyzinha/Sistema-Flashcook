  ...
  <nav class="navbar-expand-md navbar-dark bg-dark navbar fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3SupportedContent">
        ...
        <a class="btn navbar-btn btn-secondary mx-2"><b>Bem Vindo, <?php echo $_SESSION['user']; ?>!</b></a>
    ...
    <div class="jumbotron bg-secondary">
      <div class="container">
        ...
        <div class="col-md-4">
          ...
          <p>Adicione Receitas suas ou de outras pessoas, crie receitas e compartilhe.</p>
          <a class="btn btn-primary" role="button" href="adicionarReceitas.php">Adicionar</a>
        </div>
      </div>
      </div>
    </div>
